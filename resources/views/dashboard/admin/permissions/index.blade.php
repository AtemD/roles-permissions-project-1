                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a class="btn btn-primary" href="{{ route('admin.permissions.create') }}" role="button">
                            ...
                            @forelse($permissions as $permission)
                                <tr>
                                    ...
                                    <td class="project-actions">
                                        <a class="btn btn-info btn-sm" href="{{ route('admin.permissions.edit', ['permission' => $permission->id]) }}" role="button">
                                ...
                                <div class="modal fade" id="delete-permission-{{$permission->id}}" style="display: none;" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form role="form" method="POST" action="{{ route('admin.permissions.destroy', ['permission' => $permission->id]) }}">
                                            @method('DELETE')
                                            @csrf
                                            <div class="modal-body">
                                                ...
                                                <div class="alert alert-danger alert-dismissible">
                                                    ...
                                                    <br><strong>{{$permission->name}}</strong>???
